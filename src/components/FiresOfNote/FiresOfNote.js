...
const FiresOfNote = (props) => {
	return (
		<div className='fon'>
			...
			<p>Wildfires of note are those which are highly visible or that pose a potential threat to public safety. The wildfires are categorized by fire centres.</p>
